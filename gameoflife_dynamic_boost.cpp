...
/*
compile with:
    g++ -std=c++11  -I /usr/local/boost_1_59_0gameoflife_dynamic.cpp -o gameoflife
usage:
  gameoflife numrows numcolumns [maxiteration]
*/
...
int main( int argc, char  *argv[]){
  ...
  string usage = "usage: gameoflife nrows ncolumns [maxtieration" << std::endl;
  /*
                  \n \t\t nrows : number of rows in the board
                  \n \t\t ncolumns: number of columns in the board
                  \n \t\t maxiteration: max iteration of the game, default = 50" <<std::endl;
*/
  ...
  readBoard.resize(ROW_SIZE, COLUMN_SIZE);
  outBoard.resize(ROW_SIZE, COLUMN_SIZE);
